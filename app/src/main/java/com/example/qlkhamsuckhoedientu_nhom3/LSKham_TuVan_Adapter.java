...
public class LSKham_TuVan_Adapter extends BaseAdapter {
    ...
    public LSKham_TuVan_Adapter(Context context, int layout, ArrayList<ThongTinLSKham_TuVan> arrayList, DatabaseReference ref) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView tvNgayKham = view.findViewById(R.id.tvNgayKham),
                ...
                tvChuanDoan = view.findViewById(R.id.tvChuanDoan);
